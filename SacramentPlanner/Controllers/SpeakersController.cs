...
namespace SacramentPlanner.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SpeakerId,LastName,FirstName,Subject")] Speaker speaker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SpeakerId,LastName,FirstName,Subject")] Speaker speaker)
        {
